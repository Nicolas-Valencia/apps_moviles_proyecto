...
import com.example.appsmoviles.ui.screens.user.tabs.rememberLocationPermissionState
...
fun Map(
    ...
    val hasPermission = rememberLocationPermissionState {
        Toast.makeText(
            context,
            if (it) "Ha dado permiso para acceder a su ubicación" else "No ha dado permiso para acceder a su ubicación",
            Toast.LENGTH_SHORT
        ).show()
    }
